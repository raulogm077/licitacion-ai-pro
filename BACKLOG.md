...
🐛 BUG: - [ ] [Tipo: QA] [Área: Analysis] Implementar tests unitarios interactivos para FeedbackToggle y Fix E2E
  ...
  - Tipo: QA
  - Área: Analysis
> grep __dirname e2e/upload-pdf.spec.ts
> const __dirname = path.dirname(__filename);
> const pdfPath = path.resolve(__dirname, '..', 'memo_p2.pdf');
> const pdfPath = path.resolve(__dirname, '..', 'memo_p2.pdf');
> Error: __dirname is still present in the file.
...
🐛 BUG: - [ ] [Tipo: QA] [Área: Analysis] Aumentar cobertura de tests a 80%
  ...
  - Dependencias: Ninguna.
> ERROR: Coverage for functions (73%) does not meet global threshold (80%)
> ERROR: Coverage for statements (79.83%) does not meet global threshold (80%)
> ERROR: Coverage for branches (65.78%) does not meet global threshold (70%)
