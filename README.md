...
- Al validar bumps, mirar la última línea del log de `verify:release` (`completado` frente a `ELIFECYCLE`): un lote puede pasar lint, tests, build y E2E y caerse en el paso Deno, que bloquea versiones npm publicadas hace menos de 24 h.
