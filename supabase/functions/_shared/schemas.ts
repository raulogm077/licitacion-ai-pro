...
// @ts-nocheck
import { z } from 'npm:zod@3.22.4'; // Changed to npm:zod for Deno
...
const RobustBoolean = (defaultValue: boolean = false) =>
    z.preprocess(
        (val) => (val === null || val === undefined ? defaultValue : Boolean(val)),
...
export const LicitacionContentSchema = z.object({
    ...
    criteriosAdjudicacion: z.preprocess(
        (val) => val ?? {},
        z
            .object({
                subjetivos: RobustArray(
                    z.object({
    ...
    requisitosTecnicos: z.preprocess(
        (val) => val ?? {},
        z
            .object({
    ...
    requisitosSolvencia: z.preprocess(
        (val) => val ?? {},
        z
            .object({
                economica: z
                    .preprocess(
                        ...
                        z
                            ...
                            .catch({ cifraNegocioAnualMinima: 0, descripcion: undefined })
                    )
                    .default({}),
                tecnica: RobustArray(
                    z.union([
    ...
    restriccionesYRiesgos: z.preprocess(
        (val) => val ?? {},
        z
            .object({
                killCriteria: RobustArray(
                    z.union([
