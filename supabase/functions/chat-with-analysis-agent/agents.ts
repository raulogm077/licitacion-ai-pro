import { Agent } from '../_shared/agents/sdk.ts';
import { CHAT_MODEL } from '../_shared/config.ts';
import { ChatAgentOutputSchema } from './types.ts';

export function createChatAgents(readTools: any[]) {
    ...
    const manager = new Agent({
        ...
        tools: [
            ...
            criteriaAgent.asTool({
                ...
                toolDescription: 'Especialista en criterios de adjudicación y valoración.',
            }),
            solvencyAgent.asTool({
                toolName: 'solvency_agent',
                toolDescription: 'Especialista en solvencia económica, técnica y profesional.',
            }),
            riskAgent.asTool({
                toolName: 'risk_agent',
                toolDescription: 'Especialista en riesgos, restricciones y penalizaciones.',
            }),
        ],
    });
