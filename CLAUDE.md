...
- **Backports transitivos**: si el consumidor y el override admiten una versión parcheada dentro de la misma línea, fijar esa resolución en el lockfile. Precedente: `GHSA-5p4m-2wfm-xmqj` se cerró con `js-yaml@4.3.1` bajo `@eslint/eslintrc@3.3.6`, sin salto a v5 ni excepción OSV.
