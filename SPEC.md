...
- **i18n (UI/Infra):** La configuración base de `i18n` ya está implementada (`src/lib/i18n.ts`). Falta implementar el selector de idioma en la interfaz (ej. `Header.tsx`), crear los diccionarios para inglés (`en`), y comenzar a extraer textos hardcodeados de componentes clave.
