...
// Guide Vector Store ID (provided by user) - Contains the "Guía interna"
const GUIDE_VS_ID = "vs_69124e080d048191ad6c9aba5d8bb8ba";
    ...
    try {
        ...
        // Combine Guide VS and Dynamic VS
        const vectorStoreIds = [GUIDE_VS_ID, vectorStoreId];
...
0) CARGA DE MÉTODO (GUÍA)
   ...
   - Importante: Si no encuentras la GUÍA, procede con tu mejor criterio basado en el PLIEGO, pero prioriza siempre la extracción de evidencia textual.
...
- PlazoEjecucionMeses: convierte solo si es inequívoco; si no, null.
...
- pageHint: número de página si lo puedes inferir; si no, "" (string vacío).
- confidence 0..1.
...
`,
            tools: [fileSearchTool(vectorStoreIds)],
