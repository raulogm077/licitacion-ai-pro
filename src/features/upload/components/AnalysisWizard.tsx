...
export const AnalysisWizard: React.FC = () => {
    ...
    const renderStepIndicator = () => (
        <div className="flex items-center justify-center space-x-4 mb-8 text-sm font-medium">
            <div className={`flex items-center ${currentStep === 'upload' ? 'text-brand-600 dark:text-brand-400' : 'text-slate-500 dark:text-slate-400'}`}>
            ...
            <div className={`flex items-center ${currentStep === 'analyzing' ? 'text-brand-600 dark:text-brand-400' : 'text-slate-500 dark:text-slate-400'}`}>
            ...
            <ChevronRight size={16} className="text-slate-300" />
            <div className={`flex items-center ${currentStep === 'completed' ? 'text-green-600 dark:text-green-400' : 'text-slate-500 dark:text-slate-400'}`}>
