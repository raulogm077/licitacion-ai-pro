                        ...
                        <div className="max-w-[1100px] mx-auto bg-white rounded-lg shadow-sm border border-slate-200 p-8">
                           <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                               ...
                               <div>
                                   ...
                                   <p className="text-sm text-slate-500">Información administrativa e identificadores</p>
                               </div>
                           </div>
                           <ChapterDatos vm={vm} />
                        </div>
                        ...
                        <div className="max-w-[1100px] mx-auto bg-white rounded-lg shadow-sm border border-slate-200 p-8">
                            <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                               ...
                               <div>
                                   ...
                                   <p className="text-sm text-slate-500">Restricciones, penalizaciones y factores críticos</p>
                               </div>
                           </div>
