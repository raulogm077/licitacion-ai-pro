            ...
            <div className="px-4 py-3.5 border-b border-slate-200 bg-slate-50/50 flex-shrink-0">
                <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-sm font-bold text-slate-900 tracking-tight">Avisos del Pliego</h2>
                    </div>
                    <span className="text-[10px] font-semibold text-slate-500">{alerts.length} alertas</span>
                </div>
                {/* Summary badges */}
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start gap-2.5">
                                    <Icon className={clx('w-3.5 h-3.5 flex-shrink-0 mt-0.5', config.iconClass)} />
