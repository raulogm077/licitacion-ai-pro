    ...
    const metadata = [
        {
            ...
            value: dg.organoContratacion || "No detectado",
        },
        {
            icon: Layers,
            label: "Procedimiento",
        ...
        <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200 bg-slate-50/50">
                <div className="flex items-center gap-2.5">
                    ...
                    <h2 className="text-sm font-bold text-slate-900 tracking-tight">
                        Resumen Ejecutivo Autogenerado
                    </h2>
                </div>
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="space-y-3 text-sm text-slate-700 leading-relaxed">
                    <p>
                        La presente licitación, promovida por <strong>{dg.organoContratacion || 'entidad pública'}</strong>,
                        tiene por objeto <em>"{dg.titulo || 'contratación de servicios'}"</em>.
                    </p>
                    <p>
                        El presupuesto base de licitación asciende a <strong>{vm.display.presupuesto}</strong>.
                        La duración prevista es de {vm.display.plazo}.
                    </p>
                    {vm.warnings.length > 0 && (
                        <p className="text-slate-500 italic text-xs border-l-2 border-cyan/50 pl-3">
                            Nota: Se han detectado alertas y riesgos potenciales en la documentación extraída.
                            Consulte el panel lateral para mayor detalle.
                        </p>
                    )}
                </div>
